...
"""Tests for arolla.types.qvalue.dispatch_operator_qvalues."""
...
TEXT = scalar_qtypes.TEXT
UNIT = scalar_qtypes.UNIT

DispatchCase = dispatch_operator_qvalues.DispatchCase
...
class DispatchOperatorQValueTest(parameterized.TestCase):
  ...
  def test_qvalue_specialization(self):
    ...
    self.assertIsInstance(op, dispatch_operator_qvalues.DispatchOperator)
