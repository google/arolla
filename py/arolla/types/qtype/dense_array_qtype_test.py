...
class DenseArrayQTypeTest(parameterized.TestCase):
  ...
  def test_dense_array_from_values_generator(self):
    self.assertListEqual(
        array_qtype.get_array_py_value(
            dense_array_qtype.dense_array_float32(map(float, range(100)))
        ),
        list(range(100)),
    )

  @parameterized.parameters(
      (dense_array_qtype.dense_array_unit, [0]),
      (dense_array_qtype.dense_array_boolean, [0]),
      (dense_array_qtype.dense_array_boolean, [1]),
      (dense_array_qtype.dense_array_boolean, [[]]),
      (dense_array_qtype.dense_array_bytes, ['str']),
      (dense_array_qtype.dense_array_text, [b'bytes']),
      (dense_array_qtype.dense_array_int32, ['0']),
      (dense_array_qtype.dense_array_int64, ['0']),
      (dense_array_qtype.dense_array_uint64, ['0']),
      (dense_array_qtype.dense_array_float32, ['0']),
      (dense_array_qtype.dense_array_float64, ['0']),
      (dense_array_qtype.dense_array_weak_float, ['0']),
  )
  ...
  def test_dense_array_from_values_casting_value_error(self):
    qvalue = dense_array_qtype.dense_array_text([])
    with self.assertRaisesWithLiteralMatch(
      ...
      dense_array_qtype.dense_array_float32(qvalue)
  ...
  @parameterized.parameters(
      (numpy.bool_, dense_array_qtype.dense_array_boolean),
      (numpy.int32, dense_array_qtype.dense_array_int32),
      (numpy.int64, dense_array_qtype.dense_array_int64),
      (numpy.uint64, dense_array_qtype.dense_array_uint64),
      (numpy.float32, dense_array_qtype.dense_array_float32),
      (numpy.float64, dense_array_qtype.dense_array_float64),
      (numpy.float64, dense_array_qtype.dense_array_weak_float),
  )
  ...
  def test_dense_array_from_values_numpy_array_value_error(self):
    with self.assertRaises(ValueError):
      dense_array_qtype.dense_array_int32(numpy.array(['foo']))

  def test_dense_array_from_ids_and_values(self):
    values, expected_output = zip(*scalar_utils_test_helpers.FLOAT_TEST_DATA)
    qvalue = dense_array_qtype.dense_array_float32(
        values=values,
        ids=range(1, len(values) + 1),
        size=len(values) + 2,
    )
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_FLOAT32)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
  ...
  def test_dense_array_from_ids_and_values_value_error(self):
    with self.assertRaisesRegex(
      ...
      dense_array_qtype.dense_array_int64(values=[], ids=[0], size=1)
    with self.assertRaisesRegex(
        ValueError, re.escape('expected arrays of the same sizes')
    ):
      dense_array_qtype.dense_array_int64(values=[0], ids=[], size=1)
  ...
  def test_dense_array_from_ids_and_values_type_error(self):
    with self.assertRaisesRegex(
      ...
      dense_array_qtype.dense_array_int64(values=[], ids=[''], size=1)
  ...
  def test_dense_array_boolean_from_size_and_value(
    ...
    qvalue = dense_array_qtype.dense_array_boolean(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_BOOLEAN)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_bytes_from_size_and_value(self, value, expected_output):
    qvalue = dense_array_qtype.dense_array_bytes(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_BYTES)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_float32_from_size_and_value(
    ...
    qvalue = dense_array_qtype.dense_array_float32(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_FLOAT32)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
  ...
  def test_dense_array_float64_from_size_and_value(
    ...
    qvalue = dense_array_qtype.dense_array_float64(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_FLOAT64)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_weak_float_from_size_and_value(
    ...
    qvalue = dense_array_qtype.dense_array_weak_float(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_WEAK_FLOAT)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_int32_from_size_and_value(self, value, expected_output):
    qvalue = dense_array_qtype.dense_array_int32(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_INT32)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_int64_from_size_and_value(self, value, expected_output):
    qvalue = dense_array_qtype.dense_array_int64(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_INT64)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_uint64_from_size_and_value(self, value, expected_output):
    qvalue = dense_array_qtype.dense_array_uint64(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_UINT64)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_text_from_size_and_value(self, value, expected_output):
    qvalue = dense_array_qtype.dense_array_text(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_TEXT)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  def test_dense_array_unit_from_size_and_value(self, value, expected_output):
    qvalue = dense_array_qtype.dense_array_unit(value, size=5)
    self.assertEqual(qvalue.qtype, dense_array_qtype.DENSE_ARRAY_UNIT)
    self.assertListEqual(
        array_qtype.get_array_py_value(qvalue),
        [expected_output] * 5,
    )
  ...
  @parameterized.parameters(
      ...
      *((qtype, False) for qtype in array_qtype.ARRAY_QTYPES),
      (scalar_qtype.INT64, False),
  )
  def test_is_dense_array_qtype(self, qtype, expected_value):
    self.assertEqual(
        dense_array_qtype.is_dense_array_qtype(qtype), expected_value
    )

  def test_is_dense_array_qtype_type_error(self):
    with self.assertRaises(TypeError):
      dense_array_qtype.is_dense_array_qtype(0)  # pytype: disable=wrong-arg-types

  def test_make_dense_array_qtype(self):
    self.assertEqual(
        dense_array_qtype.make_dense_array_qtype(scalar_qtype.INT32),
        dense_array_qtype.DENSE_ARRAY_INT32,
    )
    self.assertEqual(
        dense_array_qtype.make_dense_array_qtype(optional_qtype.OPTIONAL_INT32),
        dense_array_qtype.DENSE_ARRAY_INT32,
    )
    with self.assertRaises(TypeError):
      _ = dense_array_qtype.make_dense_array_qtype(int)  # pytype: disable=wrong-arg-types
    with self.assertRaises(casting.QTypeError):
      _ = (
          dense_array_qtype.make_dense_array_qtype(
              dense_array_qtype.DENSE_ARRAY_INT32
          ),
      )
  ...
  def test_dense_array_from_size_and_value_missing_size(self):
    with self.assertRaisesWithLiteralMatch(
      ...
      dense_array_qtype.dense_array_unit(values=[], ids=[])
  ...
  def test_numpy_ndarray_from_dense_array(
    ...
    array = dense_array_qtype.numpy_ndarray_from_dense_array(dense_array)
  ...
  def test_numpy_ndarray_from_dense_array_value_error(self):
    dense_array = dense_array_qtype.dense_array_float32([None, 1.5])
    with self.assertRaisesWithLiteralMatch(
        ValueError,
        'dense array has missing elements, cannot provide a memoryview',
    ):
      dense_array_qtype.numpy_ndarray_from_dense_array(dense_array)

  def test_numpy_ndarray_from_dense_array_not_implemeneted_error(self):
    dense_array = dense_array_qtype.dense_array_bytes([b'foo'])
    with self.assertRaisesWithLiteralMatch(
        NotImplementedError,
