...
class QValue:
  ...
  @staticmethod
  def _arolla_unreduce(data: bytes) -> QValue: ...
...
class Expr:
  ...
  @staticmethod
  def _arolla_unreduce(data: bytes) -> Expr: ...
  ...
  def __rlshift__(self, other) -> Expr: ...
  def __rshift__(self, other) -> Expr: ...
  def __rrshift__(self, other) -> Expr: ...
...
class ReprToken:
  ...
  PRECEDENCE_OP_UNARY: Precedence = ...
  PRECEDENCE_OP_POW: Precedence = ...
  PRECEDENCE_OP_MUL: Precedence = ...
  PRECEDENCE_OP_ADD: Precedence = ...
  PRECEDENCE_OP_SHIFT: Precedence = ...
  PRECEDENCE_OP_AND: Precedence = ...
  PRECEDENCE_OP_OR: Precedence = ...
  PRECEDENCE_OP_COMPARISON: Precedence = ...
  PRECEDENCE_OP_SLICE: Precedence = ...
...
def aux_bind_arguments(
    op_or_signature: Signature | QValue | str, /, *args: Any, **kwargs: Any
) -> tuple[QValue | Expr, ...]: ...
...
def register_expr_view_member_for_aux_policy(
    aux_policy_name: str, member_name: str, expr_view_member: Any, /
) -> None: ...
...
def remove_expr_view_for_aux_policy(aux_policy_name: str, /) -> None: ...
...
class _BindArgumentsWithSignatureFn(Protocol):
  ...
  ) -> list[QValue | Expr] | tuple[QValue | Expr, ...]: ...
