...
class OperatorClassReprTest(absltest.TestCase):
  ...
  def test_precedence_constants(self):
    ...
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_SHIFT.left, 7)
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_SHIFT.right, 6)
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_AND.left, 9)
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_AND.right, 8)
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_OR.left, 11)
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_OR.right, 10)
    self.assertEqual(arolla.abc.ReprToken.PRECEDENCE_OP_COMPARISON.left, 12)
