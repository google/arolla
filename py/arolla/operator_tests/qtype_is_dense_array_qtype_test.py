...
"""Tests for M.qtype.is_dense_array_qtype operator."""
...
class QTypeIsDenseArrayQTypeTest(parameterized.TestCase):

  def test_qtype_signatures(self):
    arolla.testing.assert_qtype_signatures(
        M.qtype.is_dense_array_qtype, QTYPE_SIGNATURES  # pyrefly: ignore[missing-attribute]
    )

  @parameterized.parameters(*TEST_CASES)
  def test_eval(self, arg, expected_value):
    actual_value = arolla.eval(M.qtype.is_dense_array_qtype(arg))  # pyrefly: ignore[missing-attribute]
