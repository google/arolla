...
class QTypeIsShapeQTypeTest(parameterized.TestCase):
  ...
  def test_qtype_signatures(self):
    arolla.testing.assert_qtype_signatures(
        M.qtype.is_shape_qtype, QTYPE_SIGNATURES  # pyrefly: ignore[missing-attribute]
    )
  ...
  def test_eval(self, arg, expected_value):
    actual_value = arolla.eval(M.qtype.is_shape_qtype(arg))  # pyrefly: ignore[missing-attribute]
