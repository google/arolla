...
"""Tests for M.core._to_weak_float operator."""
...
def gen_qtype_signatures():
  """Yields qtype signatures for core._to_weak_float.
  ...
  for arg in (
    ...
    yield from pointwise_test_utils.lift_qtypes((arg, arolla.WEAK_FLOAT))


QTYPE_SIGNATURES = tuple(gen_qtype_signatures())


class CoreToWeakFloatTest(
