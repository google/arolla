...
"""Tests for M.math.trig.atan operator."""
...
def gen_test_data():
  """Returns scalar test data for math.trig.atan operator.
  ...
  return ((None, None),) + tuple((arg, float(np.arctan(arg))) for arg in values)
