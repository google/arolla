...
class CoreAnyTest(parameterized.TestCase, backend_test_base.SelfEvalMixin):
  ...
  def test_qtype_signatures(self):
    ...
    arolla.testing.assert_qtype_signatures(M.core.any, QTYPE_SIGNATURES)  # pyrefly: ignore[missing-attribute]
  ...
  def test_eval(self, *test_case):
    ...
    arolla.testing.assert_qvalue_allequal(
        self.eval(M.core.any(*args)), expected_result  # pyrefly: ignore[missing-attribute]
    )
