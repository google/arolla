...
"""Tests for M.bool.greater operator."""
...
def gen_test_data():
  """Yields test data for bool.greater operator.
...
def gen_qtype_signatures():
  """Yields qtype signatures for bool.greater.
...
class BoolGreaterTest(parameterized.TestCase):
  ...
  def testQTypeSignatures(self):
    self.assertEqual(
        ...
        frozenset(pointwise_test_utils.detect_qtype_signatures(M.bool.greater)),
    )
