...
"""Tests for M.qtype.is_array_qtype operator."""
...
TEST_CASES = (
    (arolla.UNIT, arolla.missing()),
    (arolla.BOOLEAN, arolla.missing()),
    (arolla.INT32, arolla.missing()),
    (arolla.FLOAT32, arolla.missing()),
    ...
    (arolla.DENSE_ARRAY_BOOLEAN, arolla.present()),
    (arolla.DENSE_ARRAY_INT32, arolla.present()),
    (arolla.DENSE_ARRAY_FLOAT32, arolla.present()),
    (arolla.ARRAY_UNIT, arolla.present()),
    (arolla.ARRAY_BOOLEAN, arolla.present()),
    (arolla.ARRAY_INT32, arolla.present()),
    (arolla.ARRAY_FLOAT32, arolla.present()),
...
class QTypeIsArrayQTypeTest(parameterized.TestCase):

  def test_qtype_signatures(self):
    arolla.testing.assert_qtype_signatures(
        M.qtype.is_array_qtype, QTYPE_SIGNATURES  # pyrefly: ignore[missing-attribute]
    )

  @parameterized.parameters(*TEST_CASES)
  def test_eval(self, arg, expected_value):
    actual_value = arolla.eval(M.qtype.is_array_qtype(arg))  # pyrefly: ignore[missing-attribute]
