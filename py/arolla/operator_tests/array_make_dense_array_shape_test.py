...
"""Tests for the M.array.make_dense_array_shape operator."""
...
def gen_test_cases():
  """Yields test cases for array.make_dense_array_shape.
  ...
  for i in (0, 1, 5, 100):
    for int_mod in int_modifiers:
      yield int_mod(i), arolla.types.DenseArrayShape(i)
...
class ArrayMakeDenseArrayShapeTest(
