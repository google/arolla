...
def protopath_descriptor_accessors(
  ...
  Args:
    ...
    input_cls: fully qualified class name of the input class.
  """
  ...
  def gen(cfg: Config) -> List[Tuple[str, accessors.Accessor]]:
    ...
    return protopath.accessors_from_descriptor(
        ...
        default_name_modifier_fn=(
            protopath.default_name_modifiers[naming_policy]
        ),
        accessor_input_type=input_cls,
