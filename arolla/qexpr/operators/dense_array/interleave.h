...
// Implementation of array._interleave_to_dense_array
class InterleaveToDenseArrayOperatorFamily : public OperatorFamily {
 public:
...
#endif  // AROLLA_QEXPR_OPERATORS_DENSE_ARRAY_INTERLEAVE_H_
