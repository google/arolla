...
absl::Status AppendAdd4Optimizations(PeepholeOptimizationPack& optimizations) {
  ...
  ASSIGN_OR_RETURN(optimizations.emplace_back(),
                   CreatePatternBasedOptimization(pattern1, replacement));
  ASSIGN_OR_RETURN(optimizations.emplace_back(),
                   CreatePatternBasedOptimization(pattern2, replacement));
  ASSIGN_OR_RETURN(optimizations.emplace_back(),
                   CreatePatternBasedOptimization(pattern3, replacement));
