...
//
#ifndef AROLLA_EXPR_EVAL_EXTENSIONS_PREPARE_CORE_MAP_OPERATOR_H_
#define AROLLA_EXPR_EVAL_EXTENSIONS_PREPARE_CORE_MAP_OPERATOR_H_
...
#endif  // AROLLA_EXPR_EVAL_EXTENSIONS_PREPARE_CORE_MAP_OPERATOR_H_
