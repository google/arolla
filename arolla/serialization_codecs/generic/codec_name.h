...
//
#ifndef AROLLA_SERIALIZATION_CODECS_GENERIC_CODEC_NAME_H_
#define AROLLA_SERIALIZATION_CODECS_GENERIC_CODEC_NAME_H_
...
#endif  // AROLLA_SERIALIZATION_CODECS_GENERIC_CODEC_NAME_H_
