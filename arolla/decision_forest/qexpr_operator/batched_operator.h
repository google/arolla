...
// All input types should be inherited from ArrayLikeQType. At least one input
// is required (otherwise size of the output array can not be calculated).
// Output is a tuple of arrays of the same kind as the first input.
...
#endif  // AROLLA_DECISION_FOREST_QEXPR_OPERATOR_BATCHED_OPERATOR_H_
